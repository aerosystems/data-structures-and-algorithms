...
class LinkedList {
    ...
    binaryToDecimal() {
        let temp = this.head;
        let exp = this.length - 1;
        let result = 0;
        while (temp) {
            result += Math.pow(2, exp) * temp.value;
            exp--;
            temp = temp.next;
        }
        return result;
...
list5.push(1);
list5.push(1);
console.log("Convert 11011 to 27:");
console.log("Input: 1 -> 1 -> 0 -> 1 -> 1");
console.log("Output: ", list5.binaryToDecimal());
console.log("---------------");
